...
export const LANGUAGES = [
  ...
  { id: "pt", name: "Portuguese", lat: -22.2, lon: -43.2, color: "#ff0000", description: "Portuguese was one of my first languages, and it's still the one I use most. I think in it, dream in it. It's the language that feels like home." },
